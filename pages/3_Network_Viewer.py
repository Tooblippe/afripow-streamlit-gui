...
year = str(st.selectbox("Select year", find_int_named_subdirs(Path(base_dir)/start_dir)))
...
with c:
    ...
    df.loc[df['Hour'] == 0, 'Hour'] = 24  # Adjusting so that we count hours as 1-24 instead of 0-23
